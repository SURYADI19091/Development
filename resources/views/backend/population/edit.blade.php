        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('backend.population.update', $population->id) }}" method="POST" id="populationForm">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('serial_number') is-invalid @enderror" 
                                               ...
                                               value="{{ old('serial_number', $population->serial_number) }}" required>
                                        @error('serial_number')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('family_card_number') is-invalid @enderror" 
                                               ...
                                               value="{{ old('family_card_number', $population->family_card_number) }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('identity_card_number') is-invalid @enderror" 
                                               id="identity_card_number" name="identity_card_number" 
                                               value="{{ old('identity_card_number', $population->identity_card_number) }}" 
                                               maxlength="16" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                               id="name" name="name" value="{{ old('name', $population->name) }}" required>
                                        @error('name')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('birth_place') is-invalid @enderror" 
                                               ...
                                               value="{{ old('birth_place', $population->birth_place) }}" required>
                                        @error('birth_place')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('birth_date') is-invalid @enderror" 
                                               ...
                                               value="{{ old('birth_date', $population->birth_date) }}" required>
                                        @error('birth_date')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('age') is-invalid @enderror" 
                                               id="age" name="age" value="{{ old('age', $population->age) }}" readonly>
                                        @error('age')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('gender') is-invalid @enderror" 
                                            ...
                                            <option value="M" {{ old('gender', $population->gender) == 'M' ? 'selected' : '' }}>Laki-laki</option>
                                            <option value="F" {{ old('gender', $population->gender) == 'F' ? 'selected' : '' }}>Perempuan</option>
                                        </select>
                                        @error('gender')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('marital_status') is-invalid @enderror" 
                                            ...
                                            <option value="Single" {{ old('marital_status', $population->marital_status) == 'Single' ? 'selected' : '' }}>Belum Menikah</option>
                                            <option value="Married" {{ old('marital_status', $population->marital_status) == 'Married' ? 'selected' : '' }}>Menikah</option>
                                            <option value="Divorced" {{ old('marital_status', $population->marital_status) == 'Divorced' ? 'selected' : '' }}>Cerai Hidup</option>
                                            <option value="Widowed" {{ old('marital_status', $population->marital_status) == 'Widowed' ? 'selected' : '' }}>Cerai Mati</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('family_relationship') is-invalid @enderror" 
                                               ...
                                               value="{{ old('family_relationship', $population->family_relationship) }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('head_of_family') is-invalid @enderror" 
                                               id="head_of_family" name="head_of_family" 
                                               value="{{ old('head_of_family', $population->head_of_family) }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('address') is-invalid @enderror" 
                                                  id="address" name="address" rows="3" required>{{ old('address', $population->address) }}</textarea>
                                        @error('address')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <select class="form-control @error('settlement_id') is-invalid @enderror" 
                                            ...
                                            @foreach($settlements as $settlement)
                                                <option value="{{ $settlement->id }}" 
                                                        {{ old('settlement_id', $population->settlement_id) == $settlement->id ? 'selected' : '' }}>
                                                    {{ $settlement->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('religion') is-invalid @enderror" 
                                            ...
                                            <option value="Islam" {{ old('religion', $population->religion) == 'Islam' ? 'selected' : '' }}>Islam</option>
                                            <option value="Kristen" {{ old('religion', $population->religion) == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                            <option value="Katholik" {{ old('religion', $population->religion) == 'Katholik' ? 'selected' : '' }}>Katholik</option>
                                            <option value="Hindu" {{ old('religion', $population->religion) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                                            <option value="Buddha" {{ old('religion', $population->religion) == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                            <option value="Konghucu" {{ old('religion', $population->religion) == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                                        </select>
                                        @error('religion')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('occupation') is-invalid @enderror" 
                                               ...
                                               value="{{ old('occupation', $population->occupation) }}" required>
                                        @error('occupation')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('residence_type') is-invalid @enderror" 
                                            ...
                                            <option value="Tetap" {{ old('residence_type', $population->residence_type) == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                                            <option value="Kontrak" {{ old('residence_type', $population->residence_type) == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                                            <option value="Sementara" {{ old('residence_type', $population->residence_type) == 'Sementara' ? 'selected' : '' }}>Sementara</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="Hidup" {{ old('status', $population->status ?? 'Hidup') == 'Hidup' ? 'selected' : '' }}>Hidup</option>
                                            <option value="Mati" {{ old('status', $population->status) == 'Mati' ? 'selected' : '' }}>Mati</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group" id="death_date_group" style="display: none;">
                                        ...
                                        <input type="date" class="form-control @error('death_date') is-invalid @enderror" 
                                               ...
                                               value="{{ old('death_date', $population->death_date ? $population->death_date->format('Y-m-d') : '') }}">
                                        @error('death_date')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group" id="death_cause_group" style="display: none;">
                                        ...
                                        <textarea class="form-control @error('death_cause') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Jelaskan penyebab kematian...">{{ old('death_cause', $population->death_cause) }}</textarea>
                                        @error('death_cause')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('independent_family_head') is-invalid @enderror" 
                                               ...
                                               value="{{ old('independent_family_head', $population->independent_family_head) }}" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('district') is-invalid @enderror" 
                                               ...
                                               value="{{ old('district', $population->district) }}" required>
                                        @error('district')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('regency') is-invalid @enderror" 
                                               ...
                                               value="{{ old('regency', $population->regency) }}" required>
                                        @error('regency')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('province') is-invalid @enderror" 
                                               ...
                                               value="{{ old('province', $population->province) }}" required>
                                        @error('province')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('backend.population.show', $population->id) }}" class="btn btn-info">
...
$(document).ready(function() {
    ...
    $('#populationForm input, #populationForm select, #populationForm textarea').each(function() {
        originalValues[$(this).attr('name')] = $(this).val();
    });

    $('#populationForm input, #populationForm select, #populationForm textarea').on('change', function() {
